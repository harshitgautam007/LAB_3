...
from swagger_server.models import AdminLoginBody, Database,Holidays,Leaves, MemberInformation, MemberLoginBody ,OrganizationInformation, RegisterOrgInfoBody ,Settings
...
def setup():
  with connection.cursor() as cursor:
      ...
      # organization table which has a string primary key organization_id
